                            ...
                            {product?.images && (
                              ...
                              >
                                <Image
                                  ...
                                  height={500}
                                  loading="lazy"
                                  className="w-32 md:w-40 h-32 md: md:h-40 object-cover group-hover:scale-105 overflow-hidden hoverEffect"
                                />
                              </Link>
                            )}
                ...
                <div className="lg:col-span-1">
                  <div className="hidden md:inline-block w-full bg-white p-6 rounded-lg border">
                    <div className="space-y-4">
                      ...
                      <Link
                        href={"/"}
                        className="flex items-center justify-center py-2 border border-green-500/50 rounded-full hover:border-darkColor hover:bg-green-500/5 hoverEffect"
                      >
                        <Image
                          src={paypalLogo}
                          alt="paypalLogo"
